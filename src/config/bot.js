...
export const botConfig = {
    ...
    activities: [
      {
        ...
        state: "Dm @hamza786__ for 1 like this",     // this is what people actually see
        type: 4,               // Custom
      },
    ],
  },
  ...
  tickets: {
    ...
    // Category ID where priority-sorted tickets are organized (for admin dashboard).
    priorityDashboardCategoryId: null,
